export const SKILLS_REGEX = {
  AGILE: [/agile/i, /scrum/i, /kanban/i, /pair programming/i, /\btdd\b/i, /clean architectures/i, /(metodologia(s)?|desenvolvimento) ag(eis|il)/i],
  ...
  CSS: [/\b(s)?css(3)?\b/i],
  DART: [/dart/i],
  DB: [/banco de dados/i, /mongo( )?db/i, /\b(ms-|microsoft )?sql(-| )?(server)?\b/i, /postgre(s)?/i, /mysql/i, /firebase/i, /redis/i, /no( )?sql/i, /\borm\b/i, /oracle/i],
  DELPHI: [/delphi/i],
  DEV_OPS: [/docker/i, /aws/i, /kubernetes/i, /terraform/i, /azure/i, /jenkins/i, /ci(\/|-| )?cd/i, /cloud/i, /container(s)?/i, /devops/i, /git(-| )?(hub)?(-| )actions/i],
  DJANGO: [/django/i],
  DOT_NET: [/\.net/i],
  ...
  TEST: [/jest/i, /cypress/i, /\btdd\b/i, /\be2e\b/i, /teste(s)?(\b| )((funciona(is|l) )?(unitario|automatizado)(s)?)?/i, /teste(s)? (d)?e (unidade|integracao|software|performance|depuracao)/i, /enzyme/i, /react testing library/i, /mocha/i],
