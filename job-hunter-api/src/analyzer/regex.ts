export const SKILLS_REGEX = {
  ...
  ANTD: [/ant( |-)?(d(esign)?)/i],
  AJAX: [/\bajax\b/i],
  API: [/((\bapi(s)?\b )|\b)rest(ful|\b)(?!.)?( api(s)?)?/i, /\bapi(s)?\b/i, /soap/i, /graphql/],
  APOLLO: [/apollo/i],
  ...
  CSS: [/\b(s)?css(3)?\b/i],
  DART: [/dart/i],
  DB: [/banco de dados/i, /mongo( )?db/i, /\b(ms-|microsoft )?sql(-| )?(server)?\b/i, /postgre(s)?/i, /my( )?sql/i, /firebase/i, /redis/i, /no( )?sql/i, /\borm\b/i, /oracle/i, /hibernate/i],
  DELPHI: [/delphi/i],
  ...
  JAVASCRIPT: [/java( |-)?script/i, /^(.|-)?js\b/i, /\bes6\b/i, /\bjs6\b/i],
  JQUERY: [/jquery/i],
  KOTLIN: [/kotlin/i],
  ...
  RESPONSIVE_DESIGN: [/(design|desenvolvimento) responsivo/i, /(site(s)?|aplicacoes) responsiv(o|a)(s?)/i, /responsividade/i, /mobile first/i],
  ...
  TEST: [
    ...
    /(unit|integration)( and integration)? testing/i, /testar sistemas/i, /automated test(s)?/i
  ],
...
export const BENEFITS_REGEX = {
  ...
  COURSE_HELP: [
    ...
    /desconto em universidades e cursos/i, /acesso a plataformas de ensino/i, /bolsas de estudos/i,
  ],
  ...
  PAID_VACATIONS: [/ferias ((anuais|e feriados)\s)?remunerad(a|o)(s)?/i, /descanso (anual|remunerado)/i, /paid (annual leave|vacation)/i, /ferias e feriados/i],
  ...
  REFERRAL_BONUS: [/bonus (por\s)?indicacao/i, /program of indication/i, /indicacao premiada/i, /premio indicacao/i, /Programa de indicacoes/i],
  STOCK_OPTIONS: [/stock options/i],
  TRANSPORTATION_VOUCHER: [/(vale|auxilio) transporte/i, /\bv(\.)?t(\.)?\b/i],
