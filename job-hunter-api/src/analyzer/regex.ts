export const SKILLS_REGEX = {
  ...
  SCALA: [/\bscala\b/i],
  STATE_MANAGEMENT: [/redux/i, /mobx/i, /ngrx/i, /rxjs/i, /state management/i, /(bibliotecas de )?gerenciamento de estado(s)?/i, /recoil/i, /zustand/i],
...
export const BENEFITS_REGEX = {
  ...
  COURSE_HELP: [
    ...
    /desconto em universidades e cursos/i, /acesso a plataformas de ensino/i
  ],
