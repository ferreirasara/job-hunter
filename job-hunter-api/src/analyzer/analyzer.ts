...
const SKILLS_REGEX = {
  AGILE: [/agile/i, /scrum/i, /kanban/i, /pair programming/i, /tdd/i, /clean architectures/i, /metodologias ágeis/i, /metodologias ageis/i, /metodologias ágeis/i, /desenvolvimento ágil/i],
  ANGULAR: [/angular/i],
  ANTD: [/antd/i, /ant design/i, /ant-design/i],
  AJAX: [/ajax/i],
  API: [/rest api/i, /apis restful/i, /api restful/i, /api/i, /apis rest/i, /soap/i, /graphql/],
  APOLLO: [/apollo/i],
  BACHELORS_DEGREE: [/bachelor's degree/i, /computer science/i, /bacharelado/i, /ciência da computação/i, /graduado/i, /ensino superior/i, /formação superior/i, /superior completo/i, /graduação completa/i],
  COBOL: [/cobol/i],
  ...
  DART: [/dart/i],
  DB: [/banco de dados/i, /mongodb/i, /sql/i, /sql server/i, /postgres/i, /mysql/i, /firebase/i, /redis/i, /no sql/i, /nosql/i, /orm/i, /postgre/i, /oracle/i, /ms-sql server/i],
  DELPHI: [/delphi/i],
  DEV_OPS: [/docker/i, /aws/i, /kubernetes/i, /terraform/i, /azure/i, /jenkins/i, /ci\/cd/i, /ci-cd/i, /cloud/i, /containers/i, /devops/i, /github actions/i],
  DJANGO: [/django/i],
  DOT_NET: [/\.net/i],
  ...
  TEST: [/jest/i, /cypress/i, /tdd/i, /e2e/i, /testes unitarios/i, /testes unitários/i, /testes automatizados/i, /de integração/i, /teste de software/i, /testes/i, /testes funcionais automatizados/i, /teste e depuração/i, /testes de unidade/i, /testes de performance/i, /enzyme/i, /react testing library/i, /mocha/i],
...
const BENEFITS_REGEX = {
  ...
  BIRTHDAY_DAYOFF: [/day off de aniversário/i, /day off/i, /day-off/i, /dia de folga na semana do seu aniversário/i, /dayOff no mês do aniversário/i],
  COURSE_HELP: [
    /curso de aperfeiçoamento profissional/i, /learning and development support/i, /investimento em cursos/i, /incentivo a estudos/i, /programa de capacitação/i,
    /alura/i, /acesso a cursos/i, /curso de/i, /aquisição de livros e cursos/i, /subsídio para estudo/i, /auxílio educação/i, /auxílio educação/i,
    / incentivo para educação/i
  ],
  DENTAL_PLAN: [
    /plano odontológico/i, /convênio odontológico/i, /convênio médico e odontológico/i,
    /plano de saúde e odontológico/i, /assistência médica e odontológica/i, /dental/i, /assistência odontológica/i,
    /assistências médica e odontológica/i
  ],
  ...
  HEALTH_PLAN: [
    /plano de saúde/i, /convênio saúde/i, /convênio médico e odontológico/i, /plano de saúde e odontológico/i, /assistência médica e odontológica/i,
    /health care/i, /assistência médica/i, /convênio médico/i, /health insurance/i, /health plan/i, /health and dental plan/, /assistências médica e odontológica/i
  ],
  ...
  PAID_VACATIONS: [/férias remuneradas/i, /férias anuais remuneradas/i, /descanso anual/i, /descanso remunerado/i, /paid annual leave/i, /interrupção remunerada do contrato/i, /férias remunerada/i, /férias e feriados remunerados/i],
  PRIVATE_PENSION: [/previdência privada/i],
  PSYCHOLOGICAL_HELP: [/auxílio psicológico/i, /apoio psicológico/i, /mental health/i, /apoio à saúde mental/i, /cuidado com saúde mental/i, /auxílio saúde emocional/i, /auxilio bem estar/i, /suporte social e psicológico/i],
  REFERRAL_BONUS: [/bônus indicação/i, /program of indication/i, /indicação premiada/i, /bônus por indicação de talentos/i],
