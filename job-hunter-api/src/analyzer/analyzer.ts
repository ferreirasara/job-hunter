...
const BENEFITS_REGEX = {
  ...
  PAID_VACATIONS: [/férias remuneradas/i, /férias anuais remuneradas/i, /descanso anual/i, /descanso remunerado/i, /paid annual leave/i, /interrupção remunerada do contrato/i],
