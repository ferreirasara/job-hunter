...
export const getSkillsBasedOnDescription = (job: {
  ...
  const skills: JobSkill[] = existentSkills?.length
...
export const getBenefitsBasedOnDescription = (job: {
  title: string;
  benefits?: string[];
  description: string;
}): JobBenefit[] => {
  const existentBenefits = job.benefits;
  const benefits: JobBenefit[] = existentBenefits?.length
...
export const getProgramathorNormalizedSkill = (
  skill: string,
): JobSkill | string => {
  ...
  switch (lowerCaseSkill) {
    ...
    case 'aws rds (relational database service)':
      return JobSkill.DEV_OPS;
    case 'aws s3':
      return JobSkill.DEV_OPS;
    case 'aws ec2 (elastic compute cloud)':
      return JobSkill.DEV_OPS;
    case 'azure':
      return JobSkill.DEV_OPS;
    case 'backbone.js':
      return JobSkill.BACKBONE;
    case 'bootstrap':
      return JobSkill.CSS;
    case 'c#':
      return JobSkill.CSHARP;
    case 'codeigniter':
      return JobSkill.PHP;
    case 'cloud':
      return JobSkill.DEV_OPS;
    ...
    case 'devops':
      return JobSkill.DEV_OPS;
    case 'django':
      return JobSkill.DJANGO;
    case 'docker':
      return JobSkill.DEV_OPS;
    case 'elasticsearch':
      return JobSkill.ELASTIC_SEARCH;
    case 'es6':
      return JobSkill.JAVASCRIPT;
    case 'express':
      return JobSkill.API;
    case 'firebase':
      return JobSkill.DB;
    case 'flask':
      return JobSkill.FLASK;
    case 'flutter':
      return JobSkill.FLUTTER;
    case 'figma':
      return JobSkill.PROTOTYPING;
    case 'git':
      return JobSkill.CODE_VERSIONING;
    case 'go':
      return JobSkill.GOLANG;
    case 'google cloud':
      return JobSkill.DEV_OPS;
    case 'graphql':
      return JobSkill.API;
    ...
    case 'laravel':
      return JobSkill.PHP;
    case 'lean':
      return JobSkill.LEAN;
    case 'magento':
      return JobSkill.MAGENTO;
    case 'mongodb':
      return JobSkill.DB;
    case 'mysql':
      return JobSkill.DB;
    ...
    case 'restful':
      return JobSkill.API;
    case 'ruby':
      return JobSkill.RUBY;
    case 'ruby on rails':
      return JobSkill.RUBY;
    case 'rust':
      return JobSkill.RUST;
    case 'sas':
      return JobSkill.SAS;
    case 'sass':
      return JobSkill.SASS;
    case 'scrum':
      return JobSkill.AGILE;
    case 'scss':
      return JobSkill.CSS;
    case 'server':
      return JobSkill.API;
    ...
    case 'styled - components':
      return JobSkill.STYLED_COMPONENTS;
    case 'styled-components':
      return JobSkill.STYLED_COMPONENTS;
    case 'tdd':
      return JobSkill.TEST;
    case 'testes automatizados':
      return JobSkill.TEST;
    case 'testes de regressão':
      return JobSkill.TEST;
    case 'testes funcionais':
      return JobSkill.TEST;
    case 'typescript':
      return JobSkill.TYPESCRIPT;
    case 'unity':
      return JobSkill.GAME_ENGINE;
    case 'vue.js':
      return JobSkill.VUE;
    case 'yii':
      return JobSkill.PHP;
    case 'wordpress':
      return JobSkill.WORDPRESS;
    case 'zend':
      return JobSkill.PHP;

    default: {
      console.log(
        `[getProgramathorNormalizedSkill] Skill not founded: ${lowerCaseSkill}`,
      );
...
export const getRatingsBasedOnSkillsAndBenefits = (job: {
  skills?: string[];
  benefits?: string[];
}): { skillsRating: number; benefitsRating: number } => {
  let skillsRating = 0;
...
export const getHiringRegimeBasedOnDescription = (job: {
  title: string;
  description: string;
}): JobHiringRegime => {
  if (stringContainsAny(job.title, HIRING_REGIMES_REGEX.CLT))
    return JobHiringRegime.CLT;
  if (stringContainsAny(job.title, HIRING_REGIMES_REGEX.PJ))
    return JobHiringRegime.PJ;
  if (stringContainsAny(job.description, HIRING_REGIMES_REGEX.CLT))
    return JobHiringRegime.CLT;
  if (stringContainsAny(job.description, HIRING_REGIMES_REGEX.PJ))
    return JobHiringRegime.PJ;

  return JobHiringRegime.PJ;
};

export const getTypeBasedOnDescription = (job: {
  title: string;
  description: string;
}): JobType => {
  ...
  const isFaceToFaceTitle = stringContainsAny(
    job.title,
    TYPES_REGEX.FACE_TO_FACE,
  );

  const isRemoteDescription = stringContainsAny(
    job.description,
    TYPES_REGEX.REMOTE,
  );
  const isHybridDescription = stringContainsAny(
    job.description,
    TYPES_REGEX.HYBRID,
  );
  const isFaceToFaceDescription = stringContainsAny(
    job.description,
    TYPES_REGEX.FACE_TO_FACE,
  );
...
export const getSeniorityBasedOnDescription = (job: {
  title: string;
  description: string;
}): JobSeniority => {
...
export const analyzeDescription = (job: {
  ...
  let skills = getSkillsBasedOnDescription({
    title,
    description,
    skills: oldSkills,
  });
  ...
  let benefits = getBenefitsBasedOnDescription({
    title,
    description,
  ...
  const hiringRegime = getHiringRegimeBasedOnDescription({
    title,
    description,
  });
